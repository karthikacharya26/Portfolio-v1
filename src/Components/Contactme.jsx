...
const Contactme = () => {
    ...
    const handleButtonClick = () => {
        const phoneNumber = '9822850245'; // Replace with the desired phone number
        window.location.href = `tel:${phoneNumber}`;
      };
      const emaillink = ()=>{
        window.location.href = 'karthik.ach2608@gmail.com';
      }
            ...
            <div className='contact'>
                    ...
                    <div className="details-cards">
                        <div className="details-card red" onClick={handleButtonClick}>
                            <div>
                                ...
                                <p id="contact-phone">+91 9822850245</p>
                            </div>
                        </div>
                ...
                <div className='contact-form-div'>
                    ...
                    <div className="contact-card">
                        ...
                        <form className="contact-form" action="https://formsubmit.co/karthik.ach2608@gmail.com" method="POST">
